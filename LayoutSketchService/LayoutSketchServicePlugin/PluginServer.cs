...
{
    [Guid("dc7bb756-8af9-465a-9c28-466b27ad88b1")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": LayoutSketchServicePlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": LayoutSketchServicePlugin: deactivating... ");
